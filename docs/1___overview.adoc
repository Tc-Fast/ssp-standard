...
_Maximum Reusability:_ SSP contributes to maximizing reusability of models and parameters across tools and use cases.
...
* Fix formatting (https://github.com/modelica/ssp-standard/pull/119)
* Clarification of coordinates for ssd:Note (https://github.com/modelica/ssp-standard/pull/121)
* Fix typo (https://github.com/modelica/ssp-standard/pull/129)
* Clarify generationDateAndTime format (https://github.com/modelica/ssp-standard/pull/126)
